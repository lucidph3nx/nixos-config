...
in {
  config = lib.mkIf config.nx.desktop.wallpaper.enable {
    home-manager.users.ben = {
      home.file.".config/rainbow-wallpaper-2880x1800.svg" = lib.mkIf (variant == "rainbow" && resolution == "2880x1800") {
        text = let
          colourbg = "${bg_dim}";
          colour1 = "${red}";
          colour2 = "${yellow}";
      ...
      home.file.".config/rainbow-wallpaper-5120x1440.svg" = lib.mkIf (variant == "rainbow" && resolution == "5120x1440") {
        text = let
          colourbg = "${bg_dim}";
          colour1 = "${red}";
          colour2 = "${yellow}";
